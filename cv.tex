...
\begin{sectionItemize}{$\cdot$}
	\item Programming : \highlight{C/C++}, \highlight{Python}, \highlight{MATLAB}, JAVA, \LaTeX
	\item Libraries : \highlight{Numpy}, \highlight{Scipy}, \highlight{Matplotlib}, \highlight{Brian2}, Theano, Tensorflow, \highlight{NS3}, \highlight{Django}, Struts2
