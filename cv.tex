...
\begin{sectionItemize}{$\cdot$}
	\item \highlightline{Yan Zhou}, Yaochu Jin and Jinliang Ding, “Brain-inspired Modular Reservoir based on Spiking Neurons for Multi-task Learning”. (Preparing Manuscript)
	\item \highlightline{Yan Zhou}, Yaochu Jin and Jinliang Ding, “Surrogate-Assisted Cooperative Co-evolutionary Reservoir Architecture Search for Liquid State Machines”, IEEE Transactions on Emerging Topics in Computational Intelligence, 2023.(SCI)
    \item Cheng Tang, Junkai Ji, Qiuzhen Lin and \highlightline{Yan Zhou}, "Evolutionary Neural Architecture Design of Liquid State Machine for Image Classification," ICASSP 2022 - 2022 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), 2022. (EI)
	\item \highlightline{Yan Zhou}, Yaochu Jin and Jinliang Ding, “Surrogate-Assisted Evolutionary Search of Spiking Neural Architectures in Liquid State Machines ”, Neurocomputing, 406: 12-23, 2020. (SCI, Q1)
    \item \highlightline{Yan Zhou}, Yaochu Jin and Jinliang Ding, "Evolutionary optimization of liquid state machines for robust learning", International Symposium on Neural Networks, Moscow, Russia, July 10-12, 2019. (EI)
...
\sectionTitle{\color{deep_blue} \faStarEmpty ~ Speech \& Conference Activities}
...
\sectionTitle{\color{deep_blue} \faStarEmpty ~ Journal Paper Reviewer}
    \begin{itemize}
...
\sectionTitle{\color{deep_blue} \faSuitcase ~ Employment}
